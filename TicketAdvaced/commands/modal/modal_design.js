...
export async function execute(interaction) {
    if (!interaction.isModalSubmit() || interaction.customId !== 'modal_design') {
    ...
    try {
        ...
        const ticketCategory = settings.ticketsCategories.design_category;
        ...
        const title = interaction.fields.getTextInputValue('title_design');
        const decrible = interaction.fields.getTextInputValue('description_design');
        ...
        const channel_design = await guild.channels.create({
            name: channelName,
        ...
        const buttonAcess = new ButtonBuilder()
            ...
            .setURL(`https://discord.com/channels/${interaction.guild.id}/${channel_design.id}`);
        ...
        const embed_design = new EmbedBuilder()
            ...
            .setImage(settings.tickets_images.embedDesign)
        ...
        const fixed = await channel_design.send({
            embeds: [embed_design],
