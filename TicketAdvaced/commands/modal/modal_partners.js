...
export async function execute(interaction) {
    if (!interaction.isModalSubmit() || interaction.customId !== 'modal_partners') {
    ...
    try {
        ...
        const ticketCategory = settings.ticketsCategories.partners_category;
        ...
        const title = interaction.fields.getTextInputValue('title_partners');
        const decrible = interaction.fields.getTextInputValue('description_partners');
        ...
        const channel_partners = await guild.channels.create({
            name: channelName,
        ...
        const buttonAcess = new ButtonBuilder()
            ...
            .setURL(`https://discord.com/channels/${interaction.guild.id}/${channel_partners.id}`);
        ...
        const embed_partners = new EmbedBuilder()
            .addFields(
                {
            ...
            .setImage(settings.tickets_images.embedPartners)
        ...
        const fixed = await channel_partners.send({
            embeds: [embed_partners],
