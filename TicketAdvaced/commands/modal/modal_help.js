...
export async function execute(interaction) {
    if (!interaction.isModalSubmit() || interaction.customId !== 'modal_help') {
    ...
    try {
        ...
        const ticketCategory = settings.ticketsCategories.help_category;
        ...
        const title = interaction.fields.getTextInputValue('title_help');
        const decrible = interaction.fields.getTextInputValue('description_help');
        ...
        const channel_help = await guild.channels.create({
            name: channelName,
        ...
        const buttonAcess = new ButtonBuilder()
            ...
            .setURL(`https://discord.com/channels/${interaction.guild.id}/${channel_help.id}`);
        ...
        const embed_help = new EmbedBuilder()
            ...
            .setImage(settings.tickets_images.embedHelp)
        ...
        const fixed = await channel_help.send({
            embeds: [embed_help],
